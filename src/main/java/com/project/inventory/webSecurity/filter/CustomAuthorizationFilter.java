...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
        ...
        if ( request.getServletPath ().equals ( "/api/v1/account/login" ) || request.getServletPath ().equals ( "/api/v1/account/token/refresh" ) ) {
            ...
            if ( token != null ) {
                try {
                    ...
                    SecurityContextHolder.getContext ().setAuthentication ( getAuthentication ( username, authorities ) );
    ...
    public Authentication getAuthentication ( String username, Collection<SimpleGrantedAuthority> authorities ) {
